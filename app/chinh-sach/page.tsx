...
const page = () => {
  return (
    <div className='min-h-screen pt-16 mx-auto'>
      <div className='relative h-[400px]'>
        ...
        <div className="w-full absolute bottom-[30px]">
          <div className="max-w-7xl mx-auto px-4">
            <h3 className='text-4xl md:text-5xl font-bold text-white'>Chính sách cộng đồng</h3>
          </div>
        </div>
      </div>
      <div className='flex flex-col gap-[56px] max-w-7xl mx-auto pt-[50px] pb-[96px] px-4'>
