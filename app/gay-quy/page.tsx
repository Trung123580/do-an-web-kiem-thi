  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='container mx-auto px-4 py-16 max-w-7xl'>
        <h1 className="text-5xl font-bold text-center  mb-[50px]">Vì sao ủng hộ Foundation for Future?</h1>
