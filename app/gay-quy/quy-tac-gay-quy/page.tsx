    ...
    <div>
      ...
      <div className='max-w-7xl mx-auto mt-6 px-4'>
        <div className='bg-[#F2F2F3] rounded-2xl py-8 px-[72px] flex justify-center flex-col'>
          ...
          <p className='mb-4'>
            Foundation for Future không nhận tài trợ từ các tổ chức chính phủ, đảng phái chính trị hay các tập đoàn doanh nghiệp. Các khoản tài trợ từ cá nhân và các quỹ độc lập là nguồn tài chính duy
            nhất để đảm bảo rằng chúng tôi duy trì được sự độc lập và trung lập trong mọi hoạt động hỗ trợ người khiếm thính.
          </p>
          <div className='md:text-lg font-bold'>Sàng lọc và minh bạch</div>
          <p className='mb-4'>
            Tất cả các khoản đóng góp lớn đều được kiểm tra nhằm đảm bảo không ảnh hưởng đến tính chính trực, định hướng hoạt động hoặc làm lệch mục tiêu của tổ chức. Trong trường hợp phát hiện xung
            đột lợi ích hoặc bất kỳ yếu tố không phù hợp nào, chúng tôi sẽ từ chối hoặc hoàn lại khoản tài trợ đó.
          </p>
          <div className='md:text-lg font-bold'>Trách nhiệm và hiệu quả</div>
          <p className='mb-4'>
            Chúng tôi cam kết sử dụng nguồn quỹ một cách hiệu quả và có tác động lớn nhất. Mỗi khoản đóng góp đều được sử dụng để đầu tư vào chương trình giáo dục, đào tạo nghề, nâng cao năng lực,
            phát triển công nghệ hỗ trợ và vận hành nền tảng học tập trực tuyến cho người khiếm thính.
          </p>
          <div className='md:text-lg font-bold'>Tôn trọng mong muốn của người ủng hộ</div>
          <p className='mb-4'>
            Nếu người ủng hộ muốn khoản quyên góp của mình được sử dụng vào một chương trình cụ thể, chúng tôi sẽ nỗ lực đáp ứng mong muốn đó. Mọi khoản đóng góp được phân bổ theo phương pháp kế toán
            rõ ràng và sẽ được báo cáo cụ thể trong các bản công bố hằng năm của tổ chức.
          </p>
          <div className='md:text-lg font-bold'>Tuân thủ đạo đức và pháp lý</div>
          <p className='mb-4'>
            Các phương pháp gây quỹ của Foundation for Future tuân thủ quy chuẩn đạo đức nghề nghiệp và các quy định pháp luật tại Việt Nam cũng như quốc tế. Chúng tôi luôn duy trì sự tôn trọng tuyệt
            đối đối với người ủng hộ và cộng đồng mà chúng tôi phục vụ.
          </p>
        </div>
      </div>
      <div className='max-w-7xl mx-auto mt-6 px-4'>
      ...
      <div className='mt-6 mb-24 w-full flex justify-center'>
        <button
          ...
          className='bg-[#3A63ED] font-light text-white px-7 py-2 sm:px-3 sm:py-2 md:px-6 md:py-2 lg:px-12 lg:py-3 xl:px-12 xl:py-3 2xl:px-12 2xl:py-3 rounded-md text-base sm:text-xs md:text-sm lg:text-base  hover:bg-[#89A1F4] transition-all duration-300'>
