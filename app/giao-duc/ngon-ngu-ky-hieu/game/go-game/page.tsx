    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-28 pb-8">
            <div className="container mx-auto px-4 max-w-7xl flex justify-center flex-col items-center">
                ...
                {arrAnswer && (
                    <>
                        <section className="w-[630px] h-[113px] sm:h-[276px] md:h-[329px] lg:h-[437px] xl:h-[500px] 2xl:h-[400px]">
                            <video src={arrAnswer?.video && `/image/${arrAnswer?.video}.mp4`} className="w-full h-full object-cover rounded-2xl" autoPlay={true} loop playsInline />
                        </section>
