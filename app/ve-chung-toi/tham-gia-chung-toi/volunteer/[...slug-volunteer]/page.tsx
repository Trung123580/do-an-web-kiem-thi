    ...
    <div className='min-h-screen pb-16 py-16 pt-32 mx-auto max-w-7xl px-4'>
      <div className='container mx-auto'>
        ...
        <div className='bg-[#F2F2F3] rounded-xl shadow-sm p-8 mb-8'>
          <div className='flex flex-col md:flex-row gap-3 h-full'>
            ...
            <div className='basis-2/3'>
              <p className='text-gray-700 mb-4 text-base'>{volunteerDetail?.description}</p>
        ...
        <div className='rounded-xl overflow-hidden mb-8 shadow-sm'>
          <Image src={volunteerDetail?.img || ""} alt='Workshop Volunteer Image' width={1000} height={400} className='w-full rounded-xl h-auto object-cover' />
        </div>
        ...
        <div className='text-center'>
          <button className='bg-[#3a63ed] text-white py-3 px-16 rounded-lg font-medium  hover:bg-[#89A1F4]  transition-colors text-lg'>Trở thành tình nguyện viên</button>
        </div>
      </div>
    </div>
  )
