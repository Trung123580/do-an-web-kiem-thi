    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-24 pb-8">
            <div className="container mx-auto px-4 max-w-7xl">
                {step !== 3 && <div className="shadow-sm bg-white rounded-xl py-8 px-8 mb-8 h-[400px]">
                        ...
                        {step === 2 && (
                            <>
                                <div>
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <div className="flex flex-col gap-1 text-sm font-bold">
                                            ...
                                            <input placeholder="Họ và tên*" className="outline-0 border-2 border-[#CFD1D4] px-8 py-4 rounded-lg text-lg max-w-[582px] font-normal" type="text" id="name" />
                                        </div>
                                        <div className="flex flex-col gap-1 text-sm  font-bold">
                                            <label htmlFor="email">Email</label>
                                            <input placeholder="Email*" className="outline-0 border-2 border-[#CFD1D4] px-8 py-4 rounded-lg text-lg max-w-[582px]  font-normal" type="text" id="email" />
                                        </div>
                                        <div className="flex flex-col gap-1 text-sm  font-bold">
                                            <label htmlFor="phone">Số điện thoại</label>
                                            <input placeholder="Số điện thoại*" className="outline-0 border-2 border-[#CFD1D4] px-8 py-4 rounded-lg text-lg max-w-[582px] font-normal" type="text" id="phone" />
                                        </div>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <textarea placeholder="Gửi một nội dung đến nhà tuyển dụng" className="outline-0 border-2 border-[#CFD1D4] px-8 py-4 rounded-lg text-lg w-full h-[250px] font-normal" id="coverLetter"></textarea>
                                </div>
                            </>
                        )}
                        {step === 3 && (
                            <>
                                ...
                                <div className="text-center text-lg font-normal">Cảm ơn bạn đã dành thời gian và tâm huyết để nộp hồ sơ cho Foundation for Future. <br /> Chúng tôi rất trân trọng sự quan tâm và mong muốn đóng góp của bạn cho cộng đồng người khiếm thính.</div>
                                ...
                                <ul className="flex justify-center flex-col w-full space-y-6 text-gray-600 text-base mt-4">
                                    <li className="flex text-lg font-bold text-[#3A63ED] items-center justify-center gap-2 group"><Link href={''} className="group-hover:-translate-x-1 transition-all duration-1000">Tìm hiểu các cơ hội hợp tác khác</Link><img className="group-hover:translate-x-1 transition-all duration-1000" src="/image/arrow2.png" alt="" /></li>
                                    <li className="flex text-lg font-bold text-[#3A63ED] items-center justify-center gap-2 group"><Link href={''} className="group-hover:-translate-x-1 transition-all duration-1000">Về chúng tôi</Link><img src="/image/arrow2.png" alt="" className="group-hover:translate-x-1 transition-all duration-1000" /></li>
                                    <li className="flex text-lg font-bold text-[#3A63ED] items-center justify-center gap-2 group"><Link href={''} className="group-hover:-translate-x-1 transition-all duration-1000">Các tin tức mới</Link><img src="/image/arrow2.png" alt="" className="group-hover:translate-x-1 transition-all duration-1000" /></li>
                                </ul>
                            </>
                        )}
                        {step !== 3 && <div className="md:sticky md:top-24 h-fit flex justify-center">
                            <div>
                                <button
                                    onClick={() => {
                                        if (step === 1) {
