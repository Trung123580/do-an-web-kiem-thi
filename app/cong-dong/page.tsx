  ...
  return (
    <div className='w-full'>
              ...
              <div className='bg-white rounded-2xl overflow-hidden group cursor-pointer  hover:shadow-lg hover:shadow-[#2E4FBE] transition-shadow duration-300'>
                ...
                <div className='p-6'>
                  ...
                  <div className='flex flex-grow justify-between items-center'>
                    ...
                    <button className='basis-1/3 bg-black text-white px-5 py-2 font-light rounded-md text-sm hover:bg-gray-800 transition-colors duration-300'>Tham gia</button>
                  </div>
                </div>
              </div>
            </Link>
      ...
      <div className='bg-[#111827] pb-24 pt-14 flex flex-col justify-center items-cente mt-24'>
        ...
        <div className='news-carousel !w-full mx-auto'>
          <Marquee speed={100} pauseOnHover play={play}>
            {sliderOrganizations.map((item, index) => (
              <img src={item} key={index} alt='' className='object-contain max-w-[120px] mr-[40px] md:mr-[80px]' />
            ))}
          </Marquee>
        </div>
        <button className='text-white mt-14 mx-auto' onClick={() => setPlay(!play)}>
          {play ? <FaRegCirclePause size={24} /> : <FaRegCirclePlay size={24} />}
        </button>
      </div>
    </div>
  )
