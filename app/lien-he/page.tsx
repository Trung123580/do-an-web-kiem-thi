  ...
  return (
    <>
      <div className='pb-[96px] min-h-screen pt-16 max-w-7xl mx-auto'>
        ...
        <div className='max-w-[1065px] mx-auto py-[56px] text-lg font-normal px-4'>
          <h4>Chúng tôi luôn sẵn sàng lắng nghe bạn!</h4>
          <p className='py-6'>
            Nếu bạn có bất kỳ câu hỏi, phản hồi hoặc muốn hợp tác cùng Foundation for Future trong các chương trình vì cộng đồng người khiếm thính, đừng ngần ngại liên hệ với chúng tôi qua
          </p>
        ...
        <div className='bg-[#4263EB] mx-auto px-4 py-16 text-center w-[90%] md:w-full rounded-2xl'>
