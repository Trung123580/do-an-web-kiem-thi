    ...
    <>
      <div className='mt-[80px] '>
        ...
        <div className='h-auto relative bg-[#F2F2F3] flex items-center justify-center w-full'>
          {/* Hero section */}
          <div className='flex relative mx-auto h-max max-w-7xl w-full flex-col-reverse xl:flex-row min-[1025px]:py-0 py-8'>
            <div className='relative min-[1025px]:absolute min-[1025px]:top-1/2 min-[1025px]:-translate-y-1/2 min-[1025px]:w-1/2 w-full flex justify-center flex-col min-[1025px]:px-0 px-4 min-[1025px]:mt-0 mt-5'>
            ...
            <div className='min-[1025px]:hidden flex items-center justify-center'>
              <img src='/image/nghe-nghiep/banner.png' alt='minh họa' className='object-contain w-[90%] min-[1025px]:w-1/2' />
            </div>
            <img src='/image/nghe-nghiep/banner-2.png' alt='minh họa' className='object-contain w-full min-[1025px]:block hidden' />
          </div>
        </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 mb-[96px] h-auto sm:h-[255px] md:h-[345px] lg:h-[400px] xl:h-[495px] 2xl:h-[545px] rounded-2xl overflow-hidden mt-24'>
            <div className='flex justify-evenly flex-col p-6 md:p-12'>
              <div className='space-y-6'>
                ...
                <p className='text-base sm:text-xs md:text-xs lg:text-base xl:text-lg 2xl:text-xl max-w-xl'>
                  Tư vấn và định hướng phù hợp là cách tốt nhất để giúp người khiếm thính phát huy tiềm năng, lựa chọn đúng hướng đi, và xây dựng lộ trình học tập – nghề nghiệp phù hợp với khả năng,
                  sở thích và điều kiện cá nhân
                </p>
                <Link
                  href={"/giao-duc/tu-van-dinh-huong"}
                  className='bg-[#111827] font-light text-white px-7 py-2 sm:px-3 sm:py-2 md:px-6 md:py-2 lg:px-12 lg:py-3 xl:px-12 xl:py-3 2xl:px-12 2xl:py-3 rounded-md text-base sm:text-xs md:text-sm lg:text-base  hover:bg-[#111827]/60 transition-colors duration-300'>
                  Tìm hiểu thêm
                </Link>
              </div>
            </div>
            <div className='relative z-0 overflow-visible h-[400px] sm:h-auto group'>
              <img
                ...
                className='object-cover h-full absolute bottom-0 left-0  hover:scale-100 hover:opacity-100 hover:z-10 transition-all duration-300 group-hover:opacity-40 group-hover:scale-90 '
              />
              <img
                src='/image/banner-7.png'
                alt='Education Banner'
                className='object-cover h-full absolute bottom-0 left-1/2 -translate-x-1/2 hover:scale-100 hover:opacity-100 hover:z-10 transition-all duration-300 group-hover:opacity-40 group-hover:scale-90'
              />
              <img
                src='/image/banner-8.png'
                alt='Education Banner'
                className='object-cover h-full absolute bottom-0 right-0 hover:scale-100 hover:opacity-100 hover:z-10 transition-all duration-300 group-hover:opacity-40 group-hover:scale-90'
              />
            </div>
          </div>
