                ...
                <div className='bg-white grow text-lg justify-center rounded-lg px-4 h-[57px] flex items-center gap-2 border border-[#3A63ED] relative'>
                  <div onClick={handleFilter} className='flex items-center gap-2 justify-center w-full cursor-pointer'>
                    <svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' viewBox='0 0 25 25' fill='none'>
                      <path
                        d='M11.5 20.5C11.2167 20.5 10.9792 20.4042 10.7875 20.2125C10.5959 20.0208 10.5 19.7833 10.5 19.5V13.5L4.70002 6.1C4.45002 5.76667 4.41252 5.41667 4.58752 5.05C4.76252 4.68333 5.06669 4.5 5.50002 4.5H19.5C19.9334 4.5 20.2375 4.68333 20.4125 5.05C20.5875 5.41667 20.55 5.76667 20.3 6.1L14.5 13.5V19.5C14.5 19.7833 14.4042 20.0208 14.2125 20.2125C14.0209 20.4042 13.7834 20.5 13.5 20.5H11.5ZM12.5 12.8L17.45 6.5H7.55002L12.5 12.8Z'
                        fill='#111827'
                      />
                    </svg>
                    Bộ lọc:
                        ...
                        {districts.map((district, index) => {
                          return (
                            <div key={district.value}  className='flex items-center gap-3 px-2 hover:bg-[#F2F2F3] rounded-lg'>
                              ...
                              />
                              <label className='text-[#70747D] text-base text-nowrap' htmlFor={`district-${district.value}`}>
                                Quận {district.label}
                              </label>
                              <br />
                            </div>
                      ...
                      <div className='flex flex-col gap-2 px-1 p-2.5'>
                        ...
                        {salaryRange.map((salary, index) => (
                          <div key={salary.value} className='flex items-center gap-3  px-2 hover:bg-[#F2F2F3] rounded-lg'>
                            ...
                            />
                            <label className='text-[#70747D] text-base text-nowrap' htmlFor={`district-${salary.value}`}>
                              {salary.label}
                            </label>
                            <br />
                          </div>
