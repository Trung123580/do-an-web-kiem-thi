...
export default function DonateSection() {
  ...
  return (
    <div className='w-full'>
      {/* Subscribe section */}
      <div className={`bg-[#3A63ED] text-white ${pathName === '/' ? 'px-[32px]' : 'px-4'} pt-[56px] pb-[72px]`}>
        <div className='max-w-7xl mx-auto'>
          <h3 className='text-3xl text-[32px] font-semibold mb-2'>Đăng ký thông báo</h3>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col md:flex-row gap-4 md:gap-3 xl:max-w-[70%] w-full'>
            <div className='relative'>
              ...
              <input
                ...
                type='text'
                className='flex-1 px-3  w-[196px] h-[57px] rounded-lg text-black outline-none bg-white text-sm border-2 border-[#CFD1D4]'
              />
            </div>
            <div className='relative'>
            ...
            <button type='submit' className='bg-[#111827] hover:bg-[#70747D] text-white px-[56px] py-2 rounded-[4px] text-lg font-normal transition-colors whitespace-nowrap'>
              Đăng ký
            </button>
          </form>
          ...
          <div className='flex gap-4 *:hover:bg-black/40 *:p-2 *:rounded-xl relative'>
              <a href='#'  onClick={(e) => e.stopPropagation()} className='text-white !pl-0 hover:text-white transition-colors'>
              ...
              <a href='#'  onClick={(e) => e.stopPropagation()} className='text-white hover:text-white transition-colors'>
            ...
            <div className='flex flex-wrap *:hover:underline  gap-2 md:gap-[56px] md:mt-6 mt-2 mb-4 md:mb-0 text-xl md:text-2xl'>
              <a href='/lien-he'  onClick={(e) => e.stopPropagation()} className='text-white hover:text-white transition-colors font-normal text-2xl'>
                Liên hệ với chúng tôi
              </a>
              <a href='/rieng-tu'  onClick={(e) => e.stopPropagation()} className='text-white hover:text-white transition-colors font-normal text-2xl'>
                Quyền riêng tư và Cookie
              </a>
              <a href='/chinh-sach'  onClick={(e) => e.stopPropagation()} className='text-white hover:text-white transition-colors font-normal text-2xl'>
                Chính sách cộng đồng
              </a>
              <a href='/gay-quy'  onClick={(e) => e.stopPropagation()} className='text-white hover:text-white transition-colors font-normal text-2xl'>
                Gây quỹ
              </a>
            </div>
