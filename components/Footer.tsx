    ...
    <div className='w-full'>
      ...
      <div className='bg-[#3A63ED] text-white px-4 py-8'>
        <div className='max-w-7xl mx-auto'>
          <h3 className='text-[32px] font-bold mb-1'>Đăng ký thông báo</h3>
          <p className='text-base font-medium text-white/90 mb-6 md:mb-4 max-w-3xl'>
          ...
          <div className='flex flex-col md:flex-row justify-between items-center mt-8 pt-6'>
            <div className='flex flex-wrap justify-center md:justify-start gap-4 md:gap-16 mb-4 md:mb-0 text-2xl font-normal'>
