      ...
      <div className={`bg-[#3A63ED] text-white ${pathName === '/' ? 'px-[32px]' : 'px-4'} py-8`}>
        <div className='max-w-7xl mx-auto'>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col md:flex-row gap-4 md:gap-3 xl:max-w-[70%] w-full'>
            <div className='relative'>
              ...
              <input
                ...
                type='text'
                className='flex-1 px-3 w-full h-[57px] rounded-lg text-black outline-none bg-white text-sm border-2 border-[#CFD1D4]'
              />
            </div>
            <div className='relative'>
            ...
            <button type='submit' className='bg-[#111827] hover:bg-[#70747D] text-white px-6 py-2 rounded-[4px] text-lg font-normal transition-colors whitespace-nowrap'>
              Đăng ký
            </button>
          </form>
          ...
          <div className='flex gap-4 *:hover:bg-black/40 *:p-2 *:rounded-xl'>
              <a href='#' className='text-white !pl-0 hover:text-white transition-colors'>
            ...
            <div className='flex flex-wrap *:hover:underline  gap-2 md:gap-[56px] md:mt-6 mt-2 mb-4 md:mb-0 text-xl md:text-2xl'>
              <a href='/lien-he' className='text-white hover:text-white transition-colors font-normal text-2xl'>
                Liên hệ với chúng tôi
              </a>
              <a href='/rieng-tu' className='text-white hover:text-white transition-colors font-normal text-2xl'>
                Quyền riêng tư và Cookie
              </a>
              <a href='/chinh-sach' className='text-white hover:text-white transition-colors font-normal text-2xl'>
                Chính sách cộng đồng
              </a>
              <a href='/gay-quy' className='text-white hover:text-white transition-colors font-normal text-2xl'>
                Gây quỹ
              </a>
            </div>
