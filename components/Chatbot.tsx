...
const ChatBot = () => {
  ...
  return (
    <div className="fixed bottom-14 right-[32px] w-12 h-12 bg-blue-600 rounded-full z-[999] flex items-center justify-center shadow-lg">
        ...
        <div className="bg-white w-[300px] md:w-[413px] h-[400px] md:h-[560px] bottom-14 right-2 md:right-0 absolute rounded-2xl z-50 pt-2 shadow-2xl">
          ...
          <div className="absolute bottom-0 border-t border-[#CFD1D4] w-full rounded-b-2xl px-4 py-2">
            <div className="flex flex-grow">
              <input onKeyDown={handleKeyDown} value={input} autoFocus onChange={(e) => setInput(e.target.value)} className="w-[90%] outline-0 border-0 h-[50px]" type="text" />
